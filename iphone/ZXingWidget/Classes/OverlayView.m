...
@synthesize ticketValidateLabel, markerView;
    ...
    if( self ) {
        ...
        if (isCancelEnabled) {
            ...
            if (oneDMode) {
                ...
                [cancelButton setFrame:CGRectMake(20, 190, 45, 130)];
            }
            else {
        ...
        markerView = [[UIView alloc] initWithFrame:CGRectMake(10, 10, 80, 80)];  
        [markerView setBackgroundColor:[UIColor greenColor]];
        
        ticketValidateLabel = [[UILabel alloc] initWithFrame:CGRectMake(100, 10, 160, 80)];  
        
        //      CGSize theSize = [qestion sizeWithFont:[UIFont boldSystemFontOfSize:16.0f] constrainedToSize:constraintSize lineBreakMode:UILineBreakModeWordWrap];
        //      qustionText.frame = CGRectMake(25, 5, 280, theSize.height);
        
        ticketValidateLabel.lineBreakMode = UILineBreakModeWordWrap; 
        [ticketValidateLabel setBackgroundColor: [UIColor clearColor]];
        
        [ticketValidateLabel setFont:[UIFont boldSystemFontOfSize:14.0f]];
        
        ticketValidateLabel.numberOfLines = 3;   
        ticketValidateLabel.text = @"dfdfeswedasdasdasdasdasdasdasdasdsadfgdfgdfgfdgdgdfsdasds";     
        
        statusView = [[UIView alloc] initWithFrame:CGRectMake(20, 300, 280, 100)];
        [statusView setBackgroundColor:[UIColor whiteColor]];
        [statusView addSubview:ticketValidateLabel];  
        [statusView addSubview:markerView];
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetStrokeColor(c, 0);
	CGContextSetFillColor(c, 0);
...
- (void) setValid:(Boolean)valid
{
    ...
    if (valid) { 
        self.ticketValidateLabel.text = @"The ticket is valid Ticket type: VIP"; 
        [self.markerView setBackgroundColor:[UIColor greenColor]];
    }  else {
        self.ticketValidateLabel.text = @"The ticket is not valid  Scan another ticket"; 
        [self.markerView setBackgroundColor:[UIColor redColor]];
    }
